...
%%%%001%%%%
            ...
            Ba2Sc2O8W001_gamma(j,:) = ((Ba2Sc2O8W001_F(i,:)-(Ba2Sc2O8W001_Watoms*mu_W(j,:)...
                ...
                Ba2O8W001_area+(Temp(i)*Ba2Sc2O8W001_config));
...
%%%%112%%%%
            ...
            Ba2O4W112_gamma(j,:) = ((Ba2O4W112_F(i,:)-(Ba2O4W112_Watoms*mu_W(j,:)...
                +Ba2O4W112_Baatoms*mu_Ba(j,:)+Ba2O4W112_Oatoms*mu_O(j,:)))/Ba2O4W112_area)+(Temp(i)*Ba2O4W112_config);
...
%%%%comparing surface energies%%%%
           ...
           if (gammaratioW112_Ba2Sc2O6_bareW110(j,i)>0.9) && (gammaratioW112_Ba2Sc2O6_bareW110(j,i)<1) ...
                && (gammaratioBa4O8W001_gamma_bareW110(j,i)>.9) && (gammaratioBa4O8W001_gamma_bareW110(j,i)<1) ...
                && (gammaratioW112_Ba2Sc2O6_bareW110(j,i)<gammaratioBa4O8W001_gamma_bareW110(j,i))
                
                disp('Yes!')
                q(k,:) = [Temp(i), mu_O(j), gammaratioBa4O8W001_gamma_bareW110(j,i), ...
        ...
        saveas(gcf,['allstablesurfaces_t',num2str(Temp(i,:)),'.png']);
        %gamma_bareW001(i)
        %gamma_W110(i)
        %gamma_bareW112(i)
        %Wcutoff(i,:)
